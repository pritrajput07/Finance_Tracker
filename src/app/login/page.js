        ...
        <div className="hidden lg:flex flex-col gap-8 pr-12">
          ...
          <div className="flex flex-col gap-4 max-w-md mt-8">
            ...
            <p className="text-on-surface-variant text-xl leading-relaxed mt-2">
              Experience the sanctuary of sophisticated money management. Precision meets peace of mind.
            </p>
          </div>
        </div>
          ...
          <div className="bg-surface-lowest p-10 md:p-12 rounded-[2.5rem] ghost-shadow flex flex-col gap-8 shadow-[0_24px_64px_-16px_rgba(77,68,227,0.12)]">
            ...
            <form className="flex flex-col gap-5 mt-2" onSubmit={handleLogin}>
              ...
              <div className="flex justify-end -mt-2">
                <a href="#" className="text-sm font-semibold text-primary hover:underline underline-offset-4">Forgot Password?</a>
              </div>

              <button 
                type="submit"
                disabled={isLoading}
                className="mt-4 w-full py-4 rounded-full primary-gradient text-white font-bold text-lg hover:scale-[1.02] transition-transform duration-200 shadow-[0_12px_32px_-4px_rgba(77,68,227,0.3)] disabled:opacity-75 disabled:hover:scale-100 flex justify-center items-center gap-2 group"
              >
                {isLoading ? (
            ...
            <div className="flex justify-center mt-2">
              <p className="text-on-surface-variant text-sm font-medium">
                Don't have an account? <Link href="/register" className="font-bold text-primary hover:underline underline-offset-4">Create an account</Link>
              </p>
            </div>
